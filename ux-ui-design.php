...
<html lang="en">
  <head>
    ...
    <title>UX/UI Design Course - Buff Institute</title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <style>
      ...
      .btn-success-custom {
        ...
        border-color: linear-gradient(90deg, #a855f7 0%, #ec4899 100%);
        padding: 12px 30px;
        font-size: 1.1rem;
        font-weight: 600;
        border-radius: 10px;
    ...
    <main>
      ...
      <section class="hero-section">
        <div class="container">
          ...
          <p>Become a Professional UX/UI Designer with Buff Institute</p>
          ...
          <div class="row">
            ...
            <div class="col-lg-8">
              <div class="mb-5">
                ...
                <p>
                  Welcome to Buff Institute, the destination for design
                  excellence. Our UX/UI Design Course is designed to teach user
                  experience principles, interface design techniques, and the
                  tools required to build functional and beautiful digital
                  products.
                </p>
              </div>
              ...
              <div class="mb-5">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="highlight-item">
                      <i class="bi bi-lightbulb"></i> User Research & Testing
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="highlight-item">
                      <i class="bi bi-code-slash"></i>Figma & Adobe XD Mastery
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="highlight-item">
                      <i class="bi bi-patch-check"></i>Portfolio Development
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="highlight-item">
              ...
              <div class="mb-5">
                ...
                <div class="curriculum-module">
                  <h5>Module 1: Fundamentals of UX/UI Design</h5>
                  <p class="m-2 small">
                    Understand the core concepts of UX and UI, their roles, and
                    the design process.
                  </p>
                  <ul class="mt-2">
                    <li><a href="#">What is UX & UI</a></li>
                    <li>
                      <a href="#">UX vs UI</a>
                    </li>
                    ...
                    <li>
                      <a href="#">User Goals & Pain Points</a>
                    </li>
                  </ul>
                </div>
                <div class="curriculum-module">
                  <h5>Module 2: User Research & Empathy Mapping</h5>
                  <p class="mb-0 small">
                    Learn how to understand users and gather insights to improve
                    product usability.
                  </p>
                  <ul class="mt-2">
                    <li><a href="#">User Interviews</a></li>
                    <li><a href="#">Persona Creation</a></li>
                    <li><a href="#">Empathy Maps</a></li>
                    <li><a href="#">User Journey Mapping</a></li>
                  </ul>
                </div>
                <div class="curriculum-module">
                  <h5>Module 3: Information Architecture & Wireframing</h5>
                  <p class="mb-0 small">
                    Organize content and design structure for digital products.
                  </p>
                  <ul class="mt-2">
                    <li><a href="#">Navigation Flow</a></li>
                    <li><a href="#">Sitemap Creation</a></li>
                    <li><a href="#">Wireframe Techniques</a></li>
                    <li><a href="#">Low-Fidelity Design</a></li>
                  </ul>
                </div>
                <div class="curriculum-module">
                  <h5>Module 4: UI Design & Visual Aesthetics</h5>
                  <p class="mb-0 small">
                    Design pixel-perfect interfaces and screens.
                  </p>
                  <ul class="mt-2">
                    <li><a href="#">UI Components</a></li>
                    <li><a href="#">Grids, Layouts & Spacing</a></li>
                    <li>
                      <a href="#">Color & Typography in UI</a>
                    </li>
                    <li><a href="#">Iconography & Design Consistency</a></li>
                  </ul>
                </div>
                <div class="curriculum-module">
                  <h5>Module 5: Prototyping with Figma & Adobe XD</h5>
                  <p class="mb-0 small">
                    Build interactive prototypes and collaborate with
                    stakeholders.
                  </p>
                  <ul class="mt-2">
                    <li><a href="#">Figma Tools & Workflow</a></li>
                    <li><a href="#">Adobe XD Interactive Prototypes</a></li>
                    <li><a href="#">Component Libraries</a></li>
                    <li><a href="#">Auto Layout & Variants</a></li>
                  </ul>
                </div>
                <div class="curriculum-module">
                  <h5>Module 6: Usability Testing & Feedback</h5>
                  <p class="mb-0 small">
                    Test your designs for real user feedback and iterate
                    accordingly.
                  </p>
                  <ul class="mt-2">
                    <li><a href="#">Usability Testing Methods</a></li>
                    <li><a href="#">A/B Testing</a></li>
                    <li><a href="#">User Feedback & Iteration</a></li>
                    <li><a href="#">Case Studies</a></li>
                  </ul>
                </div>
                <div class="curriculum-module">
                  <h5>Module 7: Responsive Design & Design Systems</h5>
                  <p class="mb-0 small">
                    Ensure your designs work across devices and platforms.
                  </p>
                  <ul class="mt-2">
                    <li><a href="#">Responsive Design Concepts</a></li>
                    <li><a href="#">Mobile First Design</a></li>
                    <li><a href="#">Design Systems & Style Guides</a></li>
                    <li><a href="#">Accessibility in Design</a></li>
                  </ul>
                </div>
                <div class="curriculum-module">
                  <h5>Module 8: Portfolio Development & Real Projects</h5>
                  <p class="mb-0 small">
                    Showcase your skills with real-world UX/UI projects.
                  </p>
                  <ul class="mt-2">
                    <li><a href="#">Case Study Documentation</a></li>
                    <li><a href="#">Behance & Dribbble Profiles</a></li>
                    <li><a href="#">Resume & Interview Preparation</a></li>
                    <li><a href="#">Freelance & Job Opportunities</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div class="mb-5">
                ...
                <div class="row">
                  <div class="col-md-6 col-sm-6">
                    <div class="join">Beginners in Design</div>
                  </div>
                  <div class="col-md-6 col-sm-6">
                    <div class="join">Students & Freshers</div>
                  </div>
                  <div class="col-md-6 col-sm-6">
                    <div class="join">Developers wanting to transition</div>
                  </div>
                  <div class="col-md-6 col-sm-6">
                    <div class="join">Freelancers & Professionals</div>
                  </div>
                </div>
              </div>
